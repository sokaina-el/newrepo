package com.sam.gestionventes.Utils;
...
public class HibernateUtil {
    ...
    static {
        try {
            ...
            sessionFactory = new Configuration().configure("com/sam/gestionventes/Config/hibernate_configuration.xml")
            		.buildSessionFactory();
            stockSessionFactory = new Configuration().configure("com/sam/gestionventes/Config/hibernate_stock_cfg.xml")
            		.buildSessionFactory();
